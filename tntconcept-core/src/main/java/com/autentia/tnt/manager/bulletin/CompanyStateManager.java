...
/* CompanyState - generated by stajanov (do not edit/delete) */
  ...
  private CompanyStateServiceProxy companyStateServiceProxy = new CompanyStateServiceProxyImpl();
  ...
  public List<CompanyState> getAllEntities(CompanyStateSearch search, SortCriteria sort){
   // return companyStateDAO.search( search, sort );
    return companyStateServiceProxy.getAllCompanyStates(search, sort);
  }
  ...
  public CompanyState getEntityById(int id){
    //return companyStateDAO.getById(id);
	  return (CompanyState)companyStateServiceProxy.getById(id);
  }
  ...
  public void insertEntity(CompanyState companyState) {
    ...
    companyStateServiceProxy.insertCompanyState(companyState);
  }
  ...
  public void updateEntity(CompanyState companyState) {
    ...
    companyStateServiceProxy.updateCompanyState(companyState);
  }
  ...
  public void deleteEntity(CompanyState companyState) {
    //companyStateDAO.delete(companyState);
	  companyStateServiceProxy.deleteCompanyState(companyState);
  }
